...
<body class="body1">
		...
		<nav class="navbar navbar-light">
			<div class="container-fluid">
				...
				<button class="btn btn-info btn-lg">
					<a href="home.jsp" class="active" style="color: white">Home</a>
				</button>
	...
	<%
		...
		try {
			...
			for (int i = 0; i < seats.length; i++) {
				...
				while (rs.next()) {
					if ((rs.getString(4).equals(th_name)) && (rs.getString(3).equals(movie_name))
							&& (rs.getString(5).equals(th_loc)) && (rs.getString(1).equals(show_date))
							&& (rs.getString(2).equals(show_time))) {
	...
	<div class="container">
		<div class="ticket">
			...
			%>
				<br> Theatre Name:<%
					out.print((String) th_name + " " + (String) th_loc);
				%>
				<br> Date:
				<%
	...
	<br>
	<center>
		<button onclick="myFunction()">Print Your Ticket</button>
	</center>
