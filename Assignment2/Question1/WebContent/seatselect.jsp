...
.container .checkmark:after {
	border-radius: .25em;
	background-color: #FF0000 left: 9px;
	top: 5px;
	width: 5px;
	height: 10px;
	border: solid white;
...
%>
					<td><label class="container"> <input type="checkbox"
							value=<%= " "+(j+(i*10)+1) %> disabled> <span
							class="checkmark1"></span>&nbsp&nbsp&nbsp
					</label></td>
					<% 
		...
		%>
					<td><label class="container"> <input type="checkbox"
							value=<%= " "+(j+(i*10)+1) %> name="seats" id="mycheck">
...
%>
		<center>
			<h2 font-family: "Times NewRoman">Screen This Way</h2>
		</center>
		<br>
		<center>
			<input type="submit" class="btn btn-primary" value="Confirm seats">
		</center>
	</form>
	<label class="container"> <input type="checkbox" disabled>
