    ...
    <body>
        ...
        <div class="dropdown">
    		...
    		<ul class="dropdown-menu">
      			<li><a href="#">Fri 05/11</a></li>
			     <li><a href="#">Sat 06/11</a></li>
			     <li><a href="#">Sun 07/11</a></li>
			     <li><a href="#">Mon 09/11</a></li>
			     <li><a href="#">Tue 10/11</a></li>
			     <li><a href="#">Wed 11/11</a></li>
			     <li><a href="#">Thur 12/11</a></li>
   			 </ul>
  		</div>
